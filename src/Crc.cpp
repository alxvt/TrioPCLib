///////////////////////////////////////////////////////////////////////////////
// File:		CRC.CPP
// Description:	Contains the CCRC implementation. This class calculates the
//				CRC for a given character sequence using a fast lookup table
//				based algorithm
// Copyight Trio Motion Technology 1995

// standard MSVC includes
#include "stdafx.h"

// class header
#include "CRC.h"

// CRC library. Specifies the CRC types recognized
static CRCLibraryType CRCLibrary[] = { 
	...
	{ "CRC-32", 32, 0x04c11db7, 0xffffffff, TRUE, TRUE },
	{ "", 0, 0, 0, FALSE, FALSE }
};

// macro to generate a right n bit mask, where 1<=n<=32
